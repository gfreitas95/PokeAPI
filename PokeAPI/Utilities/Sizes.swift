...
extension CGFloat {
    ...
    static let extraLargeSpace: CGFloat = 30
    
    // MARK: - Radius
    static let xyRadius: CGFloat = 5
    ...
    static let screenWidth: CGFloat = 20
    
    // MARK: - Animations
    static let smallAnimation: CGFloat = 0.4
    static let mediumAnimation: CGFloat = 1
    static let largeAnimation: CGFloat = 1.15
    static let extraLargeAnimation: CGFloat = 14
}
...
extension Double {
    ...
    static let smallAnimation: Double = 0.4
    static let mediumAnimation: Double = 0.45
}
...
extension TimeInterval {
    // MARK: - Durations
    static let smallDuration: TimeInterval = 0.1
    static let mediumDuration: TimeInterval = 0.2
    static let largeDuration: TimeInterval = 0.4
}
